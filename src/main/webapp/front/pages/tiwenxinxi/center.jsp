				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<input type="text" name="celiangshijian" id="celiangshijian" placeholder="测量时间" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">健康状态</label>
							<div class="layui-input-block">
								<select name="jiankangzhuangtai" id="jiankangzhuangtai">
							...
							<div class="layui-input-block">
								<input type="text" name="xiangqingbeizhu" id="xiangqingbeizhu" placeholder="详情备注" autocomplete="off" class="layui-input">
							</div>
						</div>
