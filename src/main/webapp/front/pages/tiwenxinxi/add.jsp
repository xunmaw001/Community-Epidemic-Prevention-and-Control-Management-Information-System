				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input v-model="detail.dizhi" type="text" name="dizhi" id="dizhi" autocomplete="off" class="layui-input">
                                                                                ...
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">测量温度：</label>
						<div class="layui-input-block">
							<input v-model="detail.celiangwendu" type="text" name="celiangwendu" id="celiangwendu" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">测量时间：</label>
						<div class="layui-input-block">
							<input type="text" name="celiangshijian" id="celiangshijian" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
                        <label class="layui-form-label">健康状态</label>
                        <div class="layui-input-block">
                            <select name="jiankangzhuangtai" id="jiankangzhuangtai" lay-filter="jiankangzhuangtai">
                                <option value="">请选择</option>
                                <option v-for="(item,index) in jiankangzhuangtai" v-bind:key="index" :value="item">{{item}}</option>
                            </select>
                        </div>
                    </div>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
				...
				http.request('config/list', 'get', {
					...
					elem: '#celiangshijian'
																...
																vue.jiankangzhuangtai = '正常,不正常'.split(',')
				...
				form.on('submit(*)', function(data) {
					...
					// 提交数据
					http.requestJson('tiwenxinxi' + '/add', 'post', data, function(res) {
					 	layer.msg('提交成功', {
					 		time: 2000,
					 		icon: 6
					 	}, function() {
