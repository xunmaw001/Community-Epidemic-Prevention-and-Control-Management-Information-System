        ...
        <div class="ng-inmod-ini">
          <div class="ng-fault ng-container">
            <div class="ng-inmod-the ng-container ng-bg-fff">
              ...
              <span class="ng-inmod-the-cn" aos="fade-down">疑似人员展示</span><span class="ng-inmod-the-en" aos="fade-up">DATA SHOW</span>
            </div>
          ...
          <fieldset class="search-container" style="text-align: center;">
            <form class="layui-form">
              ...
              <div class="layui-inline" style="margin-bottom: 10px;">
                <label class="layui-form-label">检测温度</label>
                <div class="layui-input-inline">
                  <input type="text" name="jiancewendu" id="jiancewendu" placeholder="检测温度" autocomplete="off" class="layui-input">
                </div>
              </div>   
              <div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
                ...
                <button v-if="isAuth('yisirenyuan','新增')" @click="jump('../yisirenyuan/add.jsp')" type="button" class="layui-btn btn-theme">
              ...
              <ul>
                <li v-for="(item,index) in dataList" v-bind:key="index">
                  <div class="ng-prslist-doc">
                    <div class="ng-prslist-img" @click="jump('../yisirenyuan/detail.jsp?id='+item.id)">
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#jiancewendu').val()) {
          param['jiancewendu'] = jquery('#jiancewendu').val() ? '%' + jquery('#jiancewendu').val() + '%' : '';
        }  
        // 获取列表数据
        http.request('yisirenyuan/list', 'get', param, function(res) {
