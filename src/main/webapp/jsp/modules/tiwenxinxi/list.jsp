...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">体温信息管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>体温信息列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">体温信息列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="celiangwenduSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('celiangwendu')">测量温度<i id="celiangwenduIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('celiangshijian')">测量时间<i id="celiangshijianIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			...
			if($('#celiangwenduSearch').val() != null && $('#celiangwenduSearch').val() != ''){
				searchForm.celiangwendu ="%" +  $('#celiangwenduSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("tiwenxinxi/page","GET",{
				...
				celiangwendu : searchForm.celiangwendu,	
			},(res)=>{
				if(res.code == 0){
					clear();
		...
		function setDataRow(item,number){
			...
			var celiangwenduCell  = document.createElement('td');

						 celiangwenduCell.innerHTML = item.celiangwendu;


			row.appendChild(celiangwenduCell);
			var celiangshijianCell  = document.createElement('td');

						  celiangshijianCell.innerHTML = item.celiangshijian;


			row.appendChild(celiangshijianCell);
			...
			var xiangqingbeizhuCell  = document.createElement('td');

						  if(item.xiangqingbeizhu != null && item.xiangqingbeizhu != "" && item.xiangqingbeizhu.length >= 11){
			  	xiangqingbeizhuCell.innerHTML = item.xiangqingbeizhu.substring(0, 10) + "..."; 
			  }else{
			  	xiangqingbeizhuCell.innerHTML = item.xiangqingbeizhu;
			  }


			row.appendChild(xiangqingbeizhuCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("tiwenxinxi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"tiwenxinxi");
