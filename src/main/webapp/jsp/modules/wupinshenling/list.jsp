...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">物品申领管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>物品申领管理</span></li>
								<li class="breadcrumb-item active"><span>物品申领列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">物品申领列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="wupinleixingSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
									<label>
										账号
									</label>
	...
	<script>
		...
		function search(){
			...
			if($('#wupinleixingSearch').val() != null && $('#wupinleixingSearch').val() != ''){
				searchForm.wupinleixing ="%" +  $('#wupinleixingSearch').val() + "%";
			}
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("wupinshenling/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function getSum(colName){
			http("wupinshenling"+colName,"GET",{
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"wupinshenling");
